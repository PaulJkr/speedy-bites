        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          {categories.map((cat, i) => (
            <motion.div
              ...
              className="group relative rounded-xl overflow-hidden bg-card shadow-card cursor-pointer hover:ring-2 hover:ring-primary/50 transition-all"
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6">
                ...
                <p className="font-body text-sm text-primary">{cat.count}</p>
              </div>
            </motion.div>
          ))}
        </div>
